...
class TargetTrainer(BaseRunner):
  ...
  def _training_pass(self):
    ...
    '''
    # Train on TARGET set
    target_images, target_labels = self.data_interface.get_next_batch('train', self._target_class_indices, num_shot=Constants.config['num_shot'])
    ...
    source_images, source_labels = self.data_interface.get_next_batch('train', self._source_class_indices, num_shot=Constants.config['num_shot'])
